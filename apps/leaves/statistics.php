			...
			<div class="col-md-2">
				<div class="form-group">
					...
					<select name="stattype" class="form-control" id="stattype">
						...
						<option value="single" <?php if(isset($_POST['stattype']) and trim($_POST['stattype']) == 'single') echo ' selected="selected"'; ?>>Στατιστικά Υπαλλήλου</option>
...
<div class="row">
	<div class="col-lg-12">
		<h4>Άδειες του/της <?php echo $userstat->first_name.' '.$userstat->last_name; ?></h4>
